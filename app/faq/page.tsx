...
export default function Faq() {
  const faqs = [
    { id: 1, question: "When was RocketSingh established?", answer: "RocketSingh was founded on June 14, 2018, in Kathmandu, Nepal." },
    { id: 2, question: "Where is RocketSingh located?", answer: "Headquartered at Kamalpokhari, Kathmandu, Nepal." },
    ...
    { id: 4, question: "Which industries does RocketSingh serve?", answer: "We serve residential, commercial, healthcare, hospitality, and tourism sectors in Kathmandu and nearby regions." },
    ...
    { id: 18, question: "Who are some of RocketSingh’s notable clients?", answer: "Clients include hospitals, hotels, offices, schools, and residential societies across Kathmandu." },
    ...
    { id: 24, question: "How do I provide feedback after a service?", answer: "Feedback can be submitted via our website, app, or directly to rocketsingh@sriyog.com." },
  ];

...
export default function DrainageCleaning() {
  return (
    <ServicePageLayout
      ...
      heroTitle="Drainage & Gutter Cleaning Services in Nepal"
      ...
      introParagraphs={[
        ...
        "Regular gutter and drain maintenance prevents water damage, roof issues, and unpleasant odors — especially important during Nepal's monsoon season.",
      ]}
      scopeItems={[
      ...
      faqs={[
        ...
        { id: 3, question: "Do you handle emergency drain blockages?", answer: "Yes, same-day drainage services may be available for urgent blockages in Kathmandu and nearby areas." },
        { id: 4, question: "What areas do you serve?", answer: "We provide drainage and gutter cleaning across Kathmandu, Lalitpur, Bhaktapur, and select regions in Nepal." },

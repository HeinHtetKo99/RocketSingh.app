                ...
                <section>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="p-6 card   rounded-xl shadow-sm hover:shadow-md transition-all">
                            ...
                            <p className=" mt-2 ">
                                RocketSingh was officially founded in Kathmandu, marking the beginning of its journey in delivering professional cleaning services with a commitment to quality and reliability.
                            </p>
                        </div>
